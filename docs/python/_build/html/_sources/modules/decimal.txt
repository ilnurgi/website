...
.. py:class:: Contexn(prec=None, rounding=None, traps=None, flags=None, Emin=None, Emax=None, capitals=1)
    ...
    :param list traps: список сигналов, которые возбуждают исключения в различных обстоятельствах (например, при попытке выполнить деление на ноль)
    :param list flags: список сигналов, свидетельствующих о начальном состоянии контекста (например, переполнение). Обычно аргумент flags не указывается. 
