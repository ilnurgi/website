...
.. js:class:: MediaElement()

    Наследник :js:class:`Element`


.. js:attribute:: autoplay
...
.. js:attribute:: buffered
    
    Фраг­мен­ты уже за­гру­жен­ных в бу­фер дан­ных :js:class:`TimeRanges`.


.. js:attribute:: controls
...
.. js:attribute:: defaultPlaybackRate
...
.. js:attribute:: error
    ...
    Это свой­ст­во ус­та­нав­ли­ва­ет­ся, ко­гда воз­ни­ка­ет ошиб­ка, в про­тив­ном слу­чае име­ет зна­че­ние null. Ссы­ла­ет­ся на объ­ект :js:class:`MediaError`, свой­ст­во code ко­то­ро­го опи­сы­ва­ет тип ошиб­ки.


.. js:attribute:: initialTime
...
.. js:attribute:: played
    ...
    Фраг­мен­ты :js:class:`TimeRanges`, ко­то­рые уже бы­ли про­иг­ра­ны.


.. js:attribute:: preload
...
.. js:attribute:: seekable
    
    Фраг­мент или фраг­мен­ты :js:class:`TimeRanges`, зна­че­ния вре­ме­ни для ко­то­рых мо­гут быть при­свое­ны свой­ст­ву currentTime. При про­иг­ры­ва­нии про­стых фай­лов обыч­но мож­но ус­та­но­вить лю­бое зна­че­ние от 0 до зна­че­ния свой­ст­ва duration. Но для по­то­ко­вых дан­ных по­зи­ция в  про­шлом мо­жет от­сут­ст­во­вать в  бу­фе­ре, а  по­зи­ция в  бу­ду­щем мо­жет быть еще не­дос­туп­на.


.. js:attribute:: seeking
...
.. js:function:: canPlayType(string type)
