...
.. js:class:: Text()
    ...
    .. js:function:: appendData(string text)
    ...
    .. js:function:: insertData(unsigned long offset, string text)
        
        Встав­ля­ет текст text в тек­сто­вый узел в по­зи­цию offset.


    .. js:function:: replaceData(unsigned long offset, unsigned long count, string text)
    ...
    .. js:function:: replaceWholeText(string text)
    ...
    .. js:function:: splitText(unsigned long offset)
