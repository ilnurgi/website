...
.. py:class:: CSSStyleSheet()


.. py:attribute:: cssRules

    Массив :py:class:`CSSRule`
    ...
    .. py:attribute:: ownerNode

        Возвращает эле­мент до­ку­мен­та :py:class:`Node`, «вла­дею­щий» дан­ной таб­ли­цей сти­лей, или null, ес­ли та­ко­вой от­сут­ст­ву­ет.


    .. py:attribute:: ownerRule

        Возвращает объ­ект :py:class:`CSSRule` пра­ви­ла (из ро­ди­тель­ской таб­ли­цы сти­лей), ко­то­рое при­ве­ло к вклю­че­нию дан­ной таб­ли­цы сти­лей, или null, ес­ли таб­ли­ца сти­лей бы­ла под­клю­че­на ка­ким-то дру­гим спо­со­бом. (


    .. py:attribute:: parentStyleSheet

        Таб­ли­ца сти­лей :py:class:`CSSStyleSheet`, ко­то­рая вклю­ча­ет в се­бя дан­ную таб­ли­цу, или null, ес­ли дан­ная таб­ли­ца вклю­че­на не­по­сред­ст­вен­но в до­ку­мент.
    ...
    .. py:function:: deleteRule(unsigned long index)

        Уда­ля­ет пра­ви­ло в по­зи­ции index из мас­си­ва cssRules. 


    .. py:function:: insertRule(string rule, unsigned long index)
