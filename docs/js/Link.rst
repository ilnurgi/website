...
.. js:attribute:: sheet
    ...
    Для эле­мен­тов <link>, ссы­лаю­щих­ся на таб­ли­цы сти­лей, это свой­ст­во пред­став­ля­ет свя­зан­ную таб­ли­цу сти­лей :js:class:`CSSStyleSheet`.
