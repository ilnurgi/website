...
.. js:class:: TypedArray(unsigned long length)
.. js:class:: TypedArray(TypedArray array)
.. js:class:: TypedArray(type[] array)
.. js:class:: TypedArray(ArrayBuffer buffer, [unsigned long byteOffset], [unsigned long length])

    Наследник :js:class:`ArrayBufferView`
