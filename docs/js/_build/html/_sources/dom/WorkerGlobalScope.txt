...
.. js:class:: WorkerGlobalScope()

    Наследник :js:class:`EventTarget`, :js:class:`Global`
    ...
    .. js:function:: clearInterval(long handle)
    ...
    .. js:function:: importScripts(string urls...)
    ...
    .. js:function:: setInterval(any handler, [any timeout], any args...)

        В точ­но­сти со­от­вет­ст­ву­ет од­но­имен­но­му ме­то­ду объ­ек­та Window.


    .. js:function:: setTimeout(any handler, [any timeout], any args...)
