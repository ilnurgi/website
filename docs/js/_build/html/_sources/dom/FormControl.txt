...
.. js:class:: FormControl()
    ...
    .. js:attribute:: validationMessage
    ...
    .. js:attribute:: validity
        
        Это свой­ст­во ссы­ла­ет­ся на объ­ект :js:class:`FormValidity`, ко­то­рый оп­ре­де­ля­ет кор­рект­ность да­ных в этом эле­мен­те фор­мы и опи­сы­ва­ет при­чи­ну, ес­ли дан­ные при­зна­ны не­кор­рект­ны­ми.
    ...
    .. js:function:: setCustomValidity(string error)
