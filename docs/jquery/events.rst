...
.. js:function:: toggle(f1(event), f2(event),...)
    ...
    Ре­ги­ст­ри­ру­ет об­ра­бот­чик со­бы­тия «click» во всех вы­бран­ных эле­мен­тах,
    ко­то­рый цик­ли­че­ски пе­ре­клю­ча­ет­ся ме­ж­ду ука­зан­ны­ми функ­ция­ми-об­ра­бот­чи­ка­ми.
