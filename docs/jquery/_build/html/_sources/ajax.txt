...
.. js:function:: jQuery.serialize()
    
    Се­риа­ли­зу­ет име­на и зна­че­ния вы­бран­ных форм или эле­мен­тов форм и воз­вра­ща­ет стро­ку в фор­ма­те «www-form-urlencoded».
...
.. code-block:: js
    ...
    $.ajax({
        ...
        success: function (data, textStatus) {
            // выполняется в случае успешности запроса
        }
    });

    // функция установки глобальных параметров
    $.ajaxSetup({
        url: "serverscript.php",
        global: true,
        type: "POST"
